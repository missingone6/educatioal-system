...
function changeOrder(){
    ...
    for(let i=0;i<iconfont2;i++){
        iconfont2[i].onclick =()=>{
            ...
            ajax("post","http://www.xinill.cn:80/class/grade",`schoolyear=${num[0]}&term=${num1}&sortBy=${num3}&sort=down`,function (xml:any) {
                let res = JSON.parse(xml.responseText);
                // console.log(res);
                // console.log(res.data);
                // 登录成功 term
...
determine.onclick = () => {
    ...
    let num1:string = yeartext1.innerText;
    // console.log(num1)
    let data =ajax("post","http://www.xinill.cn:80/class/grade",`schoolyear=${num[0]}&term=${num1}&sortBy=achievement&sort=down`,function (xml:any) {
        let res = JSON.parse(xml.responseText);
        // console.log(res);
        // console.log(res.data);
        // 登录成功 term
